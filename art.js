...
const Art = {
    ...
    load() {
        ...
        const optional=src=>load(src).catch(()=>null);
        ...
        return Promise.all([load('assets/tomb-sprites.png'),load('assets/tomb-materials.png'),load('assets/raider-walk.png'),load('assets/jiangshi-motion.png'),load('assets/trap-motion.png'),load('assets/tomb-mechanisms.png'),load('assets/tomb-stone-realistic.png'),load('assets/tomb-expedition.png'),load('assets/tomb-coffin-details.png'),optional('assets/empty-stone-coffin.png'),optional('assets/raider-shovel-attack-v2.png?v=2'),optional('assets/entrenching-shovel.png'),load('assets/tomb-remains.png'),optional('assets/raider-coffin-push-v2.png?v=2'),optional('assets/coffin-lid.png'),optional('assets/trap-emitters.png'),optional('assets/raider-hold-breath.png'),optional('assets/crawling-zombie-motion.webp'),optional('assets/tomb-wall-candle.webp'),optional('assets/wood-shield-realistic.png'),optional('assets/raider-shield.png'),Promise.all(relicPaths.map(optional))]).then(([sprites,materials,walker,zombies,traps,mechanisms,stone,expedition,coffinDetails,emptyCoffinImage,shovelAttack,shovelItem,remains,coffinPush,coffinLid,trapEmitters,breathRaider,crawlerMotion,wallCandle,woodShieldImage,shieldRaider,relics])=>{
