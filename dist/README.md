...
罗盘解锁小地图和目标箭头，受伤时可能掉落。油灯照明 20 秒；玉衣只能抵挡一次伤害。每层物品有限，大部分供物与僵尸藏在棺材中；普通棺有概率掉落写实古董冥器，主棺保证掉落一件，并同时释放高血量赤血厉尸与尸鳖群。僵尸或爬尸破棺后，原棺会切换为独立的写实空棺素材。关卡加载时会按墓室中轴和墙边陈设规则调整棺材、罐子、石碑、遗骸与机关间距，避免物体彼此重叠或遮挡。冥器以万元估值，过关界面会汇总全部藏品与总价值。封闭密室没有灯光，开启前场景和小地图均不可见；入口墙没有提示或特殊边框，人物必须紧贴墙面，石墙才会用约四秒缓慢打开且不再关闭。兵工铲会自动攻击近处僵尸与大罐，挥击有冷却且不能穿墙；屏气时自动攻击暂停。爬尸使用独立的四帧爬行动画。
